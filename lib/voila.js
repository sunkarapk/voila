...
var voila = module.exports = function (dir, options) {
  ...
  // Temporary hack for the bug of coffee not taking proper options
  mincer.CoffeeEngine.prototype.evaluate = function (context, locals, callback) {
    try {
      var result = this.require('coffee-script').compile(this.data, { bare: opts.bare });
